const CACHE='grove-shell-v10';
const SHELL=['./','index.html','style.css?v=10','app.js?v=10','catalog.json','icon.svg','art-0.svg','art-1.svg','art-2.svg','art-3.svg','manifest.webmanifest','icon-192.png','icon-512.png'];
