const CACHE='grove-shell-v9';
const SHELL=['./','index.html','style.css?v=9','app.js?v=9','catalog.json','icon.svg','art-0.svg','art-1.svg','art-2.svg','art-3.svg','manifest.webmanifest','icon-192.png','icon-512.png'];
